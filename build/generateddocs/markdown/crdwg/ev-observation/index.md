...
# Essential Variable Observation (Schema)

`ogc.crdwg.ev-observation` *v0.1*

A SOSA Observation Feature whose observedProperty is constrained to a CRDWG Essential Variable.
...
### Surface air temperature observation at Prague (compact)
#### json
```json
{
  "type": "Feature",
  ...
  "properties": {
    "observedProperty": "ev:surface-air-temperature",
    "resultTime": "2025-07-15T12:00:00Z",
    "hasResult": { "value": 308.2, "uom": "qudt-unit:K" },
...
### Surface air temperature observation at Prague (full EV object)
#### json
```json
{
  "type": "Feature",
...
description: Observation of a Climate Resilience Essential Variable
allOf:
  ...
  properties:
    properties:
      observedProperty:
        ...
        - type: string
          pattern: '^ev:'
        - $ref: https://ogcincubator.github.io/bblocks-helsinki-crdwg/build/annotated/crdwg/ev-schema/schema.yaml

```

Links to the schema:

* YAML version: [schema.yaml](https://ogcincubator.github.io/bblocks-helsinki-crdwg/build/annotated/crdwg/ev-observation/schema.json)
* JSON version: [schema.json](https://ogcincubator.github.io/bblocks-helsinki-crdwg/build/annotated/crdwg/ev-observation/schema.yaml)
...
[context.jsonld](https://ogcincubator.github.io/bblocks-helsinki-crdwg/build/annotated/crdwg/ev-observation/context.jsonld)
